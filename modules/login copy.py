...
from Data.Game.game_obs.ofuscar_dat import GestorProgreso
from modules.inicio import inicio

def login(self):
    datos_recuperados = GestorProgreso.cargar(password=123)
...
def name_set(self,user):
    if user!="":
        ...
        GestorProgreso.guardar(nuevos_datos, password=123)
